        ...
        <div className="ms-Grid">
            ...
            <div className="ms-Grid-row">
                <div className="ms-Grid-col ms-u-sm6 ms-u-md6 ms-u-lg6">
                    <TextField placeholder='New property name' onGetErrorMessage={props.getErrorMessage} label="Property Name" value={props.newProperty.key} onChanged={props.onKeyInputChange} />
                </div>
                <div className="ms-Grid-col ms-u-sm6 ms-u-md6 ms-u-lg6">
                    <TextField placeholder='New property value' onGetErrorMessage={props.getErrorMessage} label="Property Value" value={props.newProperty.value} onChanged={props.onValueInputChange} />
                </div>
            </div>
            <div className="ms-Grid-row">
                ...
                <div className="ms-Grid-col ms-u-sm2 ms-u-md2 ms-u-lg2 spProp-create-button">
                    <ButtonUIF buttonType={ButtonType.primary} onClick={props.addBtnClick} >
                        Create
                    </ButtonUIF>
                </div>
            </div>
