    ...
    public getFeatures(scope: FeatureScope): Promise<IFeature[]> {
        return new Promise((resolve, reject) => {
            this.getWebUrl().then(webUrl => {
                const url = webUrl + "/_layouts/ManageFeatures.aspx"
    ...
    public activateFeature(feature: IFeature): Promise<IFeature> {
        return new Promise((resolve, reject) => {
            ...
            const onError = (sender: any, err: any) => {
                ...
                ctx.executeQueryAsync(onSuccess, this.getErrorResolver(reject, constants.ERROR_MESSAGE_RESOLVER_ACTIVATING_FEATURE));
            };
