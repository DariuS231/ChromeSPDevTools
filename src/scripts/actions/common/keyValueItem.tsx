...
export default class KeyValueItem extends React.Component<KeyValueItemProps, KeyValueItemState> {
    ...
    public render() {
        ...
        if (this.state.inEditMode) {
            ...
            updateBtn = (<a href="javascript:void(0)" style={updateBtnStyle} onClick={this.onUpdateClick.bind(this) }></a>);
            ...
            let updateBtnStyle = this.getImageStyles('url(data:image/png;base64,)', 'rgba(255,255,0,0.6)');
            updateBtn = (<a href="javascript:void(0)"  style={updateBtnStyle} onClick={this.onUpdateBtnClick.bind(this) } ></a>);
        ...
        return <tr style={tableRowStyles}>
            ...
            <td>
                <a href="javascript:void(0)" style={deleteBtnStyle} onClick={this.onDeleteClick.bind(this) } title="Delete"></a>
            </td>
        </tr>;
    }
}