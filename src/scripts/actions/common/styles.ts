...
export let SpFeaturesStyles = {
    ...
    headerStyle: Utils.mergeObjects({ textAlign: 'left', wordBreak: 'break-word' }, tableCellStyle),
    activateBtnStyle: Utils.mergeObjects({
    ...
    deactivateBtnStyle: Utils.mergeObjects({
